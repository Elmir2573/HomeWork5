...
public class Main {
    public static void main(String[] args) {
        ...
        if (clientOS == 0) {
            ...
            System.out.println("Уточните, какая ОС на вашем смартфоне?");
        }
        System.out.println("Задача № 2");
        int clientDeviсeYear = 2014;
        if (clientOS == 0 && clientDeviсeYear < 2015) {
            System.out.println("Установите облегченную версию приложения для iOS по ссылке");
        } else if (clientOS == 0 && clientDeviсeYear >= 2015) {
            System.out.println("Установите обычнную версию приложения для iOS по ссылке");
        } else if (clientOS == 1 && clientDeviсeYear < 2015) {
        ...
        int year = 2021;
        if ((year > 1854 && year % 400 == 0) || (year % 4 == 0 && year % 100 != 0)) {
